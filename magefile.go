...
const (
	binaryName   = "pvdb-metrics"
	packageName  = "."
	noGitLdflags = "-X github.com/penny-vault/pvdb-metrics/common.buildDate=$BUILD_DATE"
)

var ldflags = "-X github.com/penny-vault/pvdb-metrics/common.commitHash=$COMMIT_HASH -X github.com/penny-vault/pvdb-metrics/common.buildDate=$BUILD_DATE"
